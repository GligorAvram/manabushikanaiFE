...
import { CreateDictionaryWordDto, CreateParagraphTranslationDto, CreateWordTranslationForParagraphDto, DictionaryWordDto, PageableDto, PaginatedParagraphDto, ParagraphDto, StoryDto } from 'app/models/Api';
